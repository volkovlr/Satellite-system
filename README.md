...
# Команды
1) Ниже приведен пример создания спутниковой группировки:
```
...
2) Для подсчета покрытия определенной группировкой в заданный момент времени пишется команда следующего вида:
```
...
3) Для завершения работы программы напишите "exit"
